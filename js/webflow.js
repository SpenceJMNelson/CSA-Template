...
Webflow.require('ix').init([
  ...
  {"slug":"callout-button-show","name":"callout-button-show","value":{"style":{},"triggers":[{"type":"hover","selector":".callout-button","descend":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"9px"}]}]}},
  {"slug":"hideshow-fixed-nav","name":"Hide/show fixed nav","value":{"style":{"x":"0px","y":"0px"},"triggers":[{"type":"scroll","selector":".interior-menu-fixed","offsetTop":"10%","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"-71px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}}
]);
